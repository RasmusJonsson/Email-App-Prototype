...
public class TabFragmentPrimary extends Fragment {
    @Nullable
    @Override
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final EmailAdapter emailAdapter = new EmailAdapter(TabFragmentPrimary.this.getActivity(),emails);
        final RecyclerView clv = (RecyclerView) view.findViewById(R.id.recyclerView);
        clv.setLayoutManager(new LinearLayoutManager(TabFragmentPrimary.this.getActivity()));
