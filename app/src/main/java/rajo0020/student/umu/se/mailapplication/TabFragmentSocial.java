...
public class TabFragmentSocial extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final EmailAdapter emailAdapter = new EmailAdapter(TabFragmentSocial.this.getActivity(),emails);
        final RecyclerView clv = (RecyclerView) view.findViewById(R.id.recyclerView);
        clv.setLayoutManager(new LinearLayoutManager(TabFragmentSocial.this.getActivity()));
